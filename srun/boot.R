...
system.time(b_nrep10000_c_10 <- t(mcmapply(boot_onestep, 1:10, mc.cores = 1)))
system.time(b_nrep10000_c_10 <- t(mcmapply(boot_onestep, 1:10, mc.cores = 10))) # setting cores sometimes cost more time
